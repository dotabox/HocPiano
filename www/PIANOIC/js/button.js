...
(function () {
    CAAT.RadioCheck = function () {
        CAAT.RadioCheck.superclass.constructor.call(this);
        return this;
    }

    CAAT.RadioCheck.prototype = {
        director: null,
        buttonImage: null,
        iNormal: null,
        iPress: null,
        ...
        * @param fn {function(button{CAAT.Foundation.Actor})} callback function
        */
        initialize: function (director,  check, uncheck,ischecked, fn, upFn,enterFn,exitFn,dragFn) {
            this.director = director;
            this.check = check;
            this.uncheck = uncheck;
            this.checked=ischecked;
            ischecked?this.setBackgroundImage(check):this.setBackgroundImage(uncheck);
            // this.iNormal = iNormal || 0;
            // this.iOver = iOver || this.iNormal;
            // this.iPress = iPress || this.iNormal;
            // this.iDisabled = (typeof iDisabled == "undefined")? this.iNormal: iDisabled;
       ...
       */
        ...
        */
        ...
        _down: function(self, ex, ey) {
            ...
            self.isDrag = true;
            self.pressed?self.setBackgroundImage(self.pressed):self.setBackgroundImage(self.checked?self.check:self.uncheck);
            self.fn(self,ex,ey);
        },
        ...
        _up: function (self, ex,ey) {
            ...
            self.checked?self.setBackgroundImage(self.check):self.setBackgroundImage(self.uncheck);
    ...
    extend(CAAT.RadioCheck, CAAT.Foundation.ActorContainer);
})();
